...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/pagenotfound.css" type="text/css" media="all"/>
</head>
<body>
<main>
    <svg
    ...
    <a id="errorLink" href="controller?command=home_page">Go home</a>
</main>
</body>
</html>
